...
AnimationSystem::PureResult AnimationSystem::SingleSkinnedMeshContainer::CreateSkinnedMesh(StringId id, gef::Platform& platform, std::unique_ptr<gef::Scene> modelScene)
{
    model_scene_ = std::move(modelScene);
    return Create(id, platform);
}

AnimationSystem::PureResult AnimationSystem::SingleSkinnedMeshContainer::Create(const StringId id, gef::Platform& platform)
{
